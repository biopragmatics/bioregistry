...
\midrule
Bioregistry~\cite{Hoyt2022} & Y & Y & Y & Y & o & o & o & o & o & o & o & Y & Y & Y &  & Y & Y & Y &  \\
...
Cellosaurus~\cite{Bairoch2018} & Y & Y &  &  &  & Y &  &  &  &  &  & Y & Y & Y &  &  &  &  &  \\
CHEMINF~\cite{Hastings2011} & Y &  &  &  &  &  &  &  &  &  &  & Y & Y & Y &  &  & Y &  & Y \\
CropOCT~\cite{Arnaud2020} & Y & Y &  & o &  & Y &  &  &  &  &  & Y & Y & Y &  & Y & Y &  & Y \\
...
GO~\cite{TheGeneOntologyConsortium2019} & Y & o & o & o & o & o & o &  &  &  &  & Y & Y & Y &  &  &  &  &  \\
HL7~\cite{Bender2013} & Y & o & o &  &  &  &  &  &  &  & o & Y &  & Y &  &  & Y &  &  \\
Integbio & Y & o & Y &  &  &  &  &  &  &  &  & Y & Y & Y &  &  & Y &  &  \\
LOV & Y & o & o &  &  & o &  &  &  &  &  & Y & Y & Y &  & Y & Y &  &  \\
Identifiers.org namespace~\cite{Juty2012} & Y & Y & Y & Y & Y & Y & o &  &  &  &  & Y & Y & Y &  & Y & Y & Y &  \\
N2T~\cite{Wimalaratne2018} & Y & Y & Y & Y & Y & Y & o & o &  &  &  & Y & Y & Y &  &  & Y & Y &  \\
NCBI~\cite{Clark2016} & Y & Y &  & Y &  &  &  &  &  &  &  &  & Y & Y &  &  &  &  &  \\
OBO Foundry~\cite{Jackson2021} & Y & Y & Y &  &  &  &  &  & Y &  & Y & Y & Y & Y &  & Y & Y & Y &  \\
...
re3data~\cite{Pampel2013} & Y & Y & Y &  &  &  &  &  & o &  & o &  &  & Y &  & Y & Y &  &  \\
RRID & Y & Y &  &  &  &  &  & o & o &  & o & Y & Y & Y &  & Y &  &  & Y \\
TIB-TS & Y & o & Y & o &  & o &  &  & Y & o & o & Y & Y & Y &  & Y & Y &  & Y \\
TogoID & Y & Y &  & Y & Y & Y &  &  &  &  &  & Y & Y & Y &  &  & Y &  &  \\
UniProt~\cite{Bateman2021} & Y & Y &  &  &  & Y &  &  &  &  &  & Y & Y & Y &  & Y & Y &  &  \\
Wikidata~\cite{Waagmeester2020} & Y & o & Y & o & o & o & o &  & o & o & o & Y & Y & Y &  & Y & Y &  &  \\
Wikidata (E)~\cite{Waagmeester2020} & Y & o & Y & o & o & o & o &  & o & o & o & Y & Y & Y &  & Y & Y &  &  \\
