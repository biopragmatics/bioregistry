...
class TestContexts(unittest.TestCase):
    ...
    def test_data(self):
        ...
        for key, context in self.contexts.items():
            ...
            invalid_custom_prefixes = {
                ...
                if prefix not in self.valid_prefixes and prefix not in remapping.values()
            }
            self.assertEqual(
                0,
    ...
    All prefixes in the custom prefix mapping should either be can onical prefixes or generated by the prefix remapping
